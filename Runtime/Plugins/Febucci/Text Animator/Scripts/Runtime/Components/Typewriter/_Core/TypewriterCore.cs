...
namespace Febucci.UI.Core
{
    ...
    public abstract class TypewriterCore : MonoBehaviour
    {
        ...
        {
            TextAnimator_TMP textAnimator = (TextAnimator_TMP)TextAnimator;
            Color textColor = textAnimator.TMProComponent.color;
            textAnimator.TMProComponent.color = new Color(textColor.r, textColor.g, textColor.b, 1); 
        ...
        IEnumerator ShowTextRoutine()
        {
            ...
            for (int i = 0; i < TextAnimator.CharactersCount; i++)
            {
                ...
                {
                    int maxIndex = i + 1;
                    for (int a = latestActionTriggered;
        ...
        {
            for (int i = latestEventTriggered;
