...
namespace TransitionsPlus {
    ...
    public class TransitionAnimatorEditor : Editor {
        ...
        void LoadPresets()
        {
            ...
            string dataPath = Path.Combine(Application.dataPath, "../Library/PackageCache/com.aftertime.storylineengine");
            dataPath = Path.GetFullPath(dataPath);

            string[] res = null;
            if (Directory.Exists(dataPath))
            {
                res = Directory.GetDirectories(dataPath, "*" + MASTER_FOLDER_NAME + "*", SearchOption.AllDirectories);
            }
            else
            {
                dataPath = "Packages/StorylineEngine";
                res = Directory.GetDirectories(dataPath, "*" + MASTER_FOLDER_NAME + "*", SearchOption.AllDirectories);
            }
